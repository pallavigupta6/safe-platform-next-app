...
import Link from "next/link";
import { ArrowLeft, Edit2, Lock, Shield } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Button } from "@/components/ui/button";
import { Card } from "@/components/ui/card";
import { Switch } from "@/components/ui/switch";
...
export default function ProfilePage() {
  ...
  const sidebarItems = [
    ...
    { label: "Preferences", ref: preferencesRef },
  ];
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="grid gap-8 lg:grid-cols-4">
            ...
            <nav className="sticky top-8 space-y-2">
              {sidebarItems.map((item) => (
                <button
                  ...
                  className="w-full rounded-lg px-4 py-3 text-left font-medium transition-colors text-gray-600 hover:bg-yellow-100 hover:text-gray-900"
                >
                  {item.label}
                </button>
              ))}
          ...
          <main className="lg:col-span-3 space-y-8">
            ...
            <div ref={notificationsRef} className="space-y-6">
              <Card className="border-0 bg-white p-6 shadow-sm">
                <div className="mb-6 flex items-start justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between border-b pb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Receive account updates and important alerts via email
                        </p>
                      </div>
                      <div
                        className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-medium ${preferences.emailNotifications ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}
              ...
              <Card className="border-0 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-6">
                  <div className="border-b pb-6">
                    ...
                    <select className="w-full md:w-64 rounded-lg border border-gray-300 px-4 py-2 text-gray-900 focus:border-blue-500 focus:outline-none">
